# bca Plan 4: Analyses + Identity Resolution + Kamei Enrichment + Complete Code Health
...
**Files:**
- Modify: `crates/bca-cli/src/args.rs`
- Modify: `crates/bca-lib/src/options.rs`

- [ ] **Step 1: Add Options field for complexity sampling**

In `crates/bca-lib/src/options.rs` `Options` struct, add field:
...
In `crates/bca-cli/src/args.rs`, add to `AnalyzeArgs`:
...
- Create: `crates/bca-lib/tests/mailmap_test.rs`
...
use bca_lib::test_support::tiny_repo;
...
In `crates/bca-lib/src/repo/gix_repo.rs`, replace the stub:
...
```bash
cargo test -p bca-lib --test mailmap_test --all-features
...
**Files:**
- Create: `crates/bca-lib/src/identity/mod.rs`
- Create: `crates/bca-lib/src/identity/bots.rs`
- Modify: `crates/bca-lib/src/facts/ingest.rs` (use identity::*)
- Modify: `crates/bca-lib/src/lib.rs` (add pub mod identity)
...
**Files:**
- Create: `crates/bca-lib/src/kamei/mod.rs`
- Modify: `crates/bca-lib/src/facts/ingest.rs` (call kamei::enrich after main ingest)
- Create: `crates/bca-lib/tests/kamei_test.rs`
...
pub fn enrich(db: &FactsDb) -> Result<()> {
    ...
    db.conn().execute_batch(sql)
        .map_err(|e| BcaError::Analysis(format!("kamei enrich: {e}")))?;
...
fn enrich_history_features(db: &FactsDb) -> Result<()> {
    ...
    ";
    db.conn().execute_batch(sql)
        .map_err(|e| crate::BcaError::Analysis(format!("kamei history: {e}")))?;
    Ok(())
}
...
fn enrich_experience_features(db: &FactsDb) -> Result<()> {
    ...
    ";
    db.conn().execute_batch(sql)
        .map_err(|e| crate::BcaError::Analysis(format!("kamei experience: {e}")))?;
    Ok(())
}
```
...
**Files:**
- Create: `crates/bca-lib/src/analyses/code_age.rs`
- Update: `analyses/mod.rs`
- Test: `crates/bca-lib/tests/code_age_test.rs` + Cargo.toml
...
**Files:**
- Create: `crates/bca-lib/src/analyses/churn.rs` (3 functions in one file: all share the same churn aggregation)
- Update: `analyses/mod.rs`
- Test: `crates/bca-lib/tests/churn_test.rs`
...
**Files:**
- Create: `crates/bca-lib/src/analyses/communication.rs`
- Update: `analyses/mod.rs`
- Test: `crates/bca-lib/tests/communication_test.rs`
...
**Files:**
- Create: `crates/bca-lib/src/analyses/ownership.rs`
- Update: `analyses/mod.rs`
- Test: `crates/bca-lib/tests/ownership_test.rs`
...
**Files:**
- Modify: `crates/bca-lib/Cargo.toml` (add `fishers_exact = "1"`)
- Create: `crates/bca-lib/src/analyses/coupling.rs`
- Update: `analyses/mod.rs`
- Test: `crates/bca-lib/tests/coupling_test.rs`
...
**Files:**
- Create: `crates/bca-lib/src/analyses/summary.rs`
- Update: `analyses/mod.rs`
- Test: `crates/bca-lib/tests/summary_test.rs`
...
**Files:**
- Modify: `crates/bca-lib/src/analyses/code_health.rs`
- Modify: `crates/bca-lib/tests/code_health_test.rs`
...
**Files:**
- Modify: `crates/bca-lib/src/output/csv.rs` (add emitters for each new analysis)
- Modify: `crates/bca-cli/src/main.rs` (add match arms)
- Modify: `crates/bca-cli/tests/cli_test.rs` (add 8 new CLI tests, one per analysis)
